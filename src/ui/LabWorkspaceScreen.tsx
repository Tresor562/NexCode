...
const styles = StyleSheet.create({
  ...
  rowBetween:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:10}, kicker:{color:'#8F9CFF',fontSize:10,fontWeight:'900',letterSpacing:1}, cardTitle:{color:theme.colors.text,fontSize:16,fontWeight:'850',marginTop:4}, spacer10:{height:10}, criterion:{color:theme.colors.textSecondary,fontSize:12,lineHeight:18,marginTop:7}, tabs:{gap:7,paddingBottom:8}, fileTab:{paddingHorizontal:12,paddingVertical:8,borderRadius:10,borderWidth:1,borderColor:theme.colors.border,backgroundColor:theme.colors.surface}, fileTabActive:{backgroundColor:'#1B2552',borderColor:'#4D62CC'}, fileTabText:{color:theme.colors.textSecondary,fontSize:11,fontWeight:'700'}, fileTabTextActive:{color:'#fff'},
