    ...
    <View>
      ...
      {step === 'recall' ? (
        <View style={styles.stage}>
          ...
          <Card style={styles.bigCard}>
            ...
            {!recallRevealed ? (
              <View style={styles.recallChallenge}>
                ...
                <Text style={styles.recallChallengeText}>Formule une réponse dans ta tête ou écris-la ailleurs. Le but n’est pas d’être parfait : c’est de forcer ton cerveau à retrouver l’information.</Text>
              </View>
            ) : (
          ...
          {!recallRevealed ? <PrimaryButton label="Révéler le repère" onPress={revealRecall} /> : (
            <>
