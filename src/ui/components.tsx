...
const styles = StyleSheet.create({
  card: {
    backgroundColor: 'rgba(17,23,39,.92)',
  ...
  pillPrimary: { backgroundColor: theme.colors.primaryGlass, borderColor: 'rgba(107,122,255,.28)' },
  ...
  sectionAction: { color: '#A4AEFF', fontSize: 11.5, fontWeight: theme.weight.bold },
});
