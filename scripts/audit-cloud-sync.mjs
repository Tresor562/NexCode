...
console.log('Cloud sync audit OK: immutable snapshots, remote reconciliation, account-scoped queueing, account-switch handoff, bounded retries, and follow-up flushes are protected.');
