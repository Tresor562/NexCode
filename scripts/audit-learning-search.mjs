...
console.log('Learning search audit OK: canonical intent, programming-language isolation, weighted search, scalable indexed traversal, fail-closed review clock semantics, bounded overdue urgency, prerequisite-aware readiness, mastery-safe recommendation ranking, and authored-order tie-breaking are protected.');
